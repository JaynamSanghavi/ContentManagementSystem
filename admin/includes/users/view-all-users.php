...
<div class="col-xs-12 table-responsive">
    <table class="table table-bordered table-hover">
        ...
        <?php
            ...
            while($row = mysqli_fetch_assoc($select_all_users_query)) {
                    ...
                    echo "<td><a href='users.php?subscriber=$user_id' class='btn btn-warning'><span class='fa fa-user'></span> Make Subscriber</a></td>";
    ...
    <?php
        ...
        if( isset( $_GET['subscriber'] ) ) {
                $make_subscriber_user_id = $_GET['subscriber'];
